...
class Barang_Keluar extends CI_Controller {
	function __construct()
  	{
		parent::__construct();
		$this->low = "barang_keluar";
		$this->cap = "Barang Keluar";
    ...
    public function index(){
		...
		$data['data'] = $this->db->query("SELECT bk.*, pg.nama as nama_pengguna, p.nama as nama_produk, p.harga FROM `barang_keluar` bk JOIN produk p ON bk.id_produk=p.id JOIN pengguna pg ON bk.created_by=pg.id")->result_array();
