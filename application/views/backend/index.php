...
<div class="wrapper">
    ...
    if(!isset($_SESSION['userid'])){
     ...
     ?>
     <input type="text" style="display:none" id="kurs" class='none' value="<?= Account_Helper::kurs('kurs') ?>">
    <!-- /.content-wrapper -->
...
<script>
  ...
  var JENIS_KELAMIN = <?php echo json_encode(JENIS_KELAMIN) ?>;
</script>
