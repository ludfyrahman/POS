            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?= $no ?></td>
                    <td><?= $d['nama_produk'].' [ '.$d['nama_suplier'].' ] ' ?></td>
                    <td><?= $d['jumlah'] ?></td>
                    <td><?= Response_Helper::toRupiah($d['total'])."[".Pembayaran[$d['pembayaran']]."]" ?></td>
                    <td>
                        <a href="<?= base_url($this->uri->segment(1).'/detail/'.$d['id_produk']) ?>"><span class="badge bg-blue"><i class="fa fa-book"></i></span></a>
